...
namespace Snowshoes.Common
{
    public static class SnagIt
    {
        ...
        {
            return unit.ItemQuality < UnitItemQuality.Rare6
                   && unit.ItemQuality >= UnitItemQuality.Magic1
        ...
        {
            return unit.ItemType != UnitItemType.CraftingPlan_Jeweler
                   && unit.ItemType != UnitItemType.CraftingPlan_Smith
                   && unit.ItemType != UnitItemType.CraftingReagent
                   && unit.ItemQuality < UnitItemQuality.Rare6
                   && unit.ItemQuality >= UnitItemQuality.Magic1
                   && unit.ItemLevelRequirement < 60;
        }
